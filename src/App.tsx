    ...
    <div className="min-h-screen flex flex-col">
      <div className="px-6 py-3 flex items-center justify-between border-b">
        ...
        <div className="flex items-center gap-3">
          <span className="text-sm text-muted-foreground">Desenvolvido por Yuri Alves 😎</span>
      ...
      <main className="flex-1 p-6 flex gap-6">
        <div className="flex flex-col flex-1 gap-4">
          ...
          <p className="text-sm text-muted-foreground">
            Lembre-se: você pode usar a variável <code className="text-green-600">{'{transcription}'}</code> no prompt, para incluir a transcrição do video.
          </p>
        </div>
